...
#variables that control pd accross LED
long_pathlength = 20 #in mm must be greater than print_structure_length
short_pathlength = 8 #in mm
number_of_meanders = 1 #the greater the number the higher the pd accross LED
...
number_of_LED = (printlength - (2*betweenLED_pathgap+tipsize_in) + tipsize_in)/LED_length
...
#file- singlelayer
g = G(
        outfile = "/Users/juliagrotto/Documents/Github/PrintCode_Julia/serpentine/tunableserpentine_singlelayer.txt",
...
#file- doublelayer
g = G(
        outfile = "/Users/juliagrotto/Documents/Github/PrintCode_Julia/serpentine/tunableserpentine_doublelayer.txt",
        header = "/Users/juliagrotto/Documents/Github/PrintCode_Julia/header_batteryprinter.txt",
        footer = "/Users/juliagrotto/Documents/Github/PrintCode_Julia/footer_batteryprinter.txt",
        aerotech_include = False,
        direct_write = False,
